...
- The Go server owns room mode, player slots, lobby timing and chat fan-out.
- The first player in a room is the authoritative game host.
- Joined clients send normalized input over WebSocket.
- The host simulates movement, bombs, flames, damage, lives, power-ups and optional AI/teams/ghost rules, then publishes state snapshots.
